...
ax2 = ax1.twiny()
ax2.plot(cloud_numden[10,:], atmosphere_alts_m/1000.,'--', color = 'k', linewidth=3., alpha=0.3)
...
ax1.plot(radiance[0], tan_alts_km, color = 'b', label='l-layer clouds', linewidth=2.5, alpha=0.5)
ax2.plot(cloud_numden[10,:], atmosphere_alts_m/1000.,'--', color = 'b', linewidth=2.5, alpha=0.5)
...
ax1.plot(radiance[0], tan_alts_km, color = 'r', label='2-layer clouds', linewidth=1.5, alpha=0.7)
ax2.plot(cloud_numden[10,:], atmosphere_alts_m/1000.,'--', color = 'r', linewidth=1.5, alpha=0.7)
...
pngname = '../fig/'+'fig_cloud_2d2lyr.png'
